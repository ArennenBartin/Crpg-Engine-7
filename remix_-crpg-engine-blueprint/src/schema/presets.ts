...
const characterSpriteOverrides: Record<string, IllustratedSpriteDefinition> = {
  ...
  spr_sister_vela: {
    ...
    width: 242,
    height: 512,
    data_url: "/sprites/npcs/sister-vela-mouthstone.png",
    pixels: [],
  },
  ...
  spr_orin_glassworks_hand: {
    display_name: "Orin, Glassworks Hand",
    width: 262,
    height: 512,
    data_url: "/sprites/npcs/orin-glassworks-hand.png",
    pixels: [],
  },
  spr_liss: {
    display_name: "Liss",
  ...
  spr_marta_lower_graves: {
    display_name: "Marta of the Lower Graves",
    width: 239,
    height: 512,
    data_url: "/sprites/npcs/marta-lower-graves.png",
    pixels: [],
  },
  spr_cosmas_pilgrim: {
    display_name: "Cosmas the Pilgrim",
  ...
  spr_rite_remnant: {
    ...
    width: 303,
    height: 512,
    data_url: "/sprites/enemies/rite-remnant.png",
    pixels: [],
  },
  spr_candle_eaten: {
    ...
    width: 314,
    height: 512,
    data_url: "/sprites/enemies/candle-eaten.png",
    pixels: [],
  },
  spr_partial_conversion: {
    display_name: "Partial Conversion",
    width: 268,
    height: 512,
    data_url: "/sprites/enemies/partial-conversion.png",
    pixels: [],
  },
  spr_bound_remnant: {
    display_name: "The Grid-Sick / Bound Remnant",
    width: 618,
    height: 768,
    data_url: "/sprites/enemies/bound-remnant.png",
    pixels: [],
  },
  spr_wayside_candle: {
