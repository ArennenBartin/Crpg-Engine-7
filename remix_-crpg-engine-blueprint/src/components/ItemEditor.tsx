...
import { ItemData } from "../schema/game";
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4 bg-neutral-950/50 border border-neutral-800 p-4 rounded-md">
                 ...
                 <div className="space-y-1 text-sm">
                    ...
                    <input 
                      type="number"
                      className="w-full bg-black border border-amber-800/60 rounded p-1 text-amber-200"
                      value={activeItem.effects?.damage || ""}
                      onChange={(e) => handleUpdate({ effects: { ...activeItem.effects, damage: parseInt(e.target.value) || undefined } })}
                    />
                    <p className="text-[11px] text-amber-400/80">The item-use runtime does not apply damage yet.</p>
                 </div>
                 <div className="space-y-1 text-sm">
