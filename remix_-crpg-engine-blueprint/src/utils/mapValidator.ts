// Map validator — lint pass that runs over a generated map and reports the
// problems that the engine cares about. Designed to run inside the
// generator (`const problems = validateMap(result); console.log(...)`) so
// bugs surface the moment the code is written, not after preview.
